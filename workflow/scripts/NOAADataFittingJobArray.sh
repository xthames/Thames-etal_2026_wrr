...
#SBATCH --job-name=statecu_NOAADataFittingJobArray
...
CONFIG_FILEPATH="/storage/home/ayt5134/work/research/StateCU/configs/NOAA_Config.txt"
...
# (1) bias correct the NOAA observations
# -- get the stations from the noaa_data directory
NOAA_FILES=($(ls /storage/home/ayt5134/work/research/StateCU/noaa))	
PY_STR_BIASCORR="python /storage/home/ayt5134/work/research/StateCU/scripts/NOAAClimateDataReader.py"
SRUN_OPTS_BIASCORR="--exclusive --nodes=1 --ntasks=1 --cpus-per-task=12"
PARALLEL_OPTS_BIASCORR="--joblog /storage/home/ayt5134/work/research/StateCU/jobs/parallel/statecu_NOAABiasCorrect.log --delay 0.1auto --jobs 12 -N 1"
srun $SRUN_OPTS_BIASCORR parallel $PARALLEL_OPTS_BIASCORR $PY_STR_BIASCORR ::: ${NOAA_FILES[@]} &
wait
...
SRUN_OPTS_FIT="--exclusive --nodes=1 --ntasks=1 --cpus-per-task=4"
...
SRUN_OPTS_VALIDATE="--exclusive --nodes=1 --ntasks=1 --cpus-per-task=8"
